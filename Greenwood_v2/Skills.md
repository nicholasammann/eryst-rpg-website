...
title: Skills
layout: page
parent: Greenwood 2.0
---

- [Overview](#overview)
  - [Combat Skill Rolls](#combat-skill-rolls)
    - [Basic Examples](#basic-examples)
      - [Successful Defense](#successful-defense)
      - [Successful Attack](#successful-attack)
    - [Advanced Examples](#advanced-examples)
    - [Special Attack Against Armored Defender](#special-attack-against-armored-defender)
    - [Special Attack Against Prepared Defender](#special-attack-against-prepared-defender)
    - [Standard Attack Against Defender with Shield](#standard-attack-against-defender-with-shield)
- [Skill List](#skill-list)
  - [Combat Skills](#combat-skills)
    ...
    - [Axes](#axes)
    - [Flails](#flails)
    - [Greatclubs, Greathammers](#greatclubs-greathammers)
  ...
  - [Mystical Powers](#mystical-powers)
    - [Mythological Patron](#mythological-patron)
  ...
  - [Social Skills](#social-skills)
    ...
    - [Courtly Manners](#courtly-manners)
    - [Deception](#deception)
    - [Insight](#insight)
    - [Inspiration](#inspiration)
    - [Intimidation](#intimidation)
    - [Persuasion](#persuasion)
  - [Studied Skills](#studied-skills)
    - [Alchemy](#alchemy)
...
When one creature attacks another, both creatures perform a Combat Skill Roll. The attacker's Skill Roll represents their attempt to land a hit against the defender. The defender's Skill Roll represents their attempt to block or parry the attacker's weapon.

If the attacker's Skill Roll is higher than the defender's Skill Roll, the attacker rolls the necessary dice to determine how much damage was dealt. The defender adjusts the damage dealt if they have any effect or condition that affects damage received.
...
1. The attacker has the Adept rank in the Staves skill. The attacker decides to perform the Standard Attack action and chooses a creature to attack.
2. The attacker rolls 2d6, with a total result of 9.
3. The defender has the Expert rank in the Spear skill. The defender rolls 3d6, with a total result of 12.
4. The attacker fails to land a hit on the defender.
...
5. The attacker rolls 1d4 (defined by the Standard Attack action in the Staves skill table) with a total result of 3.
6. The defender subtracts 3 from their current Hit Points.

### Advanced Examples

### Special Attack Against Armored Defender

1. The attacker has the Expert rank in the Axes skill. The attacker decides to perform the Heavy Attack action and chooses a creature to attack.
...
2. The attacker has the Expert rank in the Axes skill. The attacker decides to perform the Heavy Attack action and chooses a creature to attack.
...
7. The attacker is wearing Metal armor, which reduces damage by 4. The defender subtracts 2 from their current Hit Points.

### Standard Attack Against Defender with Shield

1. The attacker has the Adept rank in the Axes skill. The attacker decides to perform the Standard Attack action and chooses a creature to attack.
...
4. The defender is using a Medium shield. The defender adds +2 to their Skill Roll, for a total result of 11.
4. The attacker fails to land a hit on the defender.
...
| Title                | Description | Rank   | Action Cost |
| -------------------- | ----------- | ------ | ----------- |
| Standard Climb Speed | 1/2 area    | Novice | 1           |
| Improved Climb Speed | 1 area      | Adept  | 1           |
| Expert Climber       | 2 area      | Expert | 1           |
...
| Title              | Description | Rank   | Action Cost |
| ------------------ | ----------- | ------ | ----------- |
| Standard Dig Speed | 1/4 area    | Novice | 1           |
| Improved Dig Speed | 1/2 area    | Adept  | 1           |
| Expert Digger      | 1 area      | Expert | 1           |

### Jumping

| Title         | Description | Rank   | Action Cost |
| ------------- | ----------- | ------ | ----------- |
| Standard Jump | 1/4 area    | Novice | 1           |
| Improved Jump | 1/2 area    | Adept  | 1           |
| Expert Jumper | 1 area      | Expert | 1           |
...
| Title               | Description | Rank   | Action Cost |
| ------------------- | ----------- | ------ | ----------- |
| Standard Swim Speed | 1/2 area    | Novice | 1           |
| Improved Swim Speed | 1 area      | Adept  | 1           |
| Expert Swimmer      | 2 area      | Expert | 1           |
